"""
Configuration & Hyperparameters for Traffic Flow Regression
"""
import os
import torch
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'outputs_reg')
...
OUTPUT_DIM = 1               # Single continuous value output
